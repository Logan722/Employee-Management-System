...
while True:
    ...
    funct = int(input("Choose which of the following options (1 / 2 / 3 / 4) you would like to proceed with:\n"
                "Option 1: Add Employees \n" "Option 2: View Employees In The Database \n" 
                      "Option 3: Search Employee by SSN \n"
                      "Option 4: Edit Employee Info In The Database \n" "What Is Your Choice? "))
    ...
    if funct == 1:
        ...
        print("Invalid Choice. Kindly input 1 / 2 / 3")
        continue
